...
citep:haushofer-shapiro13,blattman14,blattman13. While this
...
The census was completed in April of 2013 and 745 women were identified as eligible. Of
...
# respondents who were not found at baseline were still surveyed at endline.
...
means.insert(len(means.columns), 'Delta Cash', means['Cash'] - means['Control'])

d = {'Control': means['Control'], 'Delta TUP': means['TUP'] - means['Control'], 'Delta Cash': means['Cash'] - means['Control']}
...
for column in column_list:
    ...
    pvalue_cash = stats.ttest_ind(df_1[df_1['Group'] == 'Cash'][column], df_1[df_1['Group'] == 'Control'][column], nan_policy='omit').pvalue
    
    if pvalue_cash <= 0.01: 
        means.at[column,'Delta Cash'] = means.at[column,'Delta Cash'] + '***'
...
|                          | Control | Delta TUP | Delta Cash |       N |
|--------------------------+---------+-----------+------------+---------|
| c_meat_b                 |   4.205 |    -0.568 |     -0.052 | 378.000 |
| c_fish_b                 |   2.505 |    -0.154 |     -0.156 | 474.000 |
| c_cereals_b              |   9.187 |    -0.947 |       0.27 | 605.000 |
| c_sugar_b                |   1.713 |    -0.078 |     -0.189 | 604.000 |
| c_egg_b                  |   1.096 |    -0.091 |      0.038 | 276.000 |
| c_oil_b                  |   1.364 |    -0.131 |     -0.141 | 613.000 |
| c_beans_b                |   0.696 |     0.231 |      0.226 | 192.000 |
| c_fruit_b                |    0.69 |    -0.089 |        0.0 | 272.000 |
| c_salt_b                 |   0.447 |    -0.026 |      0.007 | 617.000 |
| c_vegetables_b           |   1.543 |    -0.165 |      -0.18 | 471.000 |
| c_milk_b                 |   1.284 |    -0.237 |     -0.232 | 114.000 |
| c_spices_b               |    0.23 |     0.024 |     -0.045 | 158.000 |
| c_alcohol_b              |   0.043 |     0.006 |     -0.029 |  18.000 |
| c_otherfood_b            |     0.0 |       0.0 |        0.0 |   0.000 |
| c_fuel_b                 |   0.762 |    -0.039 |     -0.072 | 456.000 |
| c_soap_b                 |   0.483 |    -0.009 |     -0.026 | 536.000 |
| c_transport_b            |   0.176 |    -0.033 |      0.002 | 193.000 |
| c_cosmetics_b            |   0.682 |     0.027 |     -0.125 | 468.000 |
| c_entertainment_b        |   0.087 |    -0.024 |      -0.02 | 145.000 |
| c_clothesfootwear_b      |   0.658 |    -0.026 |      0.033 | 595.000 |
| c_charities_b            |    0.03 |    -0.006 |       -0.0 | 134.000 |
| c_ceremonies_b           |   0.132 |     0.007 |      0.026 | 152.000 |
| c_textiles_b             |   0.154 |    -0.005 |     0.055* | 376.000 |
| c_utensils_b             |   0.246 |    -0.008 |      0.008 | 442.000 |
| c_dowry_b                |   1.256 |     -0.04 |      0.028 | 126.000 |
| c_furniture_b            |   0.196 |    -0.014 |      0.044 | 368.000 |
| c_other_b                |     0.0 |       0.0 |        0.0 |   0.000 |
| asset_val_cows_b         |  253.31 |  -140.605 |    -99.681 |  35.000 |
| asset_val_smallanimals_b | 236.601 |   -86.069 |   -123.134 | 123.000 |
| asset_val_bicycle_b      | 109.075 |   -12.554 |    -11.413 | 171.000 |
| asset_val_radio_b        |  58.448 |    -5.969 |    -16.529 | 260.000 |
| asset_val_motorcycle_b   | 341.737 |   192.956 |  353.836** |  93.000 |
| asset_val_net_b          |  19.164 |     0.668 |      0.248 | 423.000 |
| asset_val_poultry_b      |  42.402 |    -3.365 |     -8.894 | 161.000 |
| asset_val_bed_b          |  241.27 |     7.992 |     32.762 | 521.000 |
| asset_val_chairtables_b  | 206.786 |   -29.368 |      3.617 | 531.000 |
| asset_val_mobile_b       |  97.537 |    12.627 |     -4.199 | 414.000 |
| asset_val_netITN_b       |   7.822 |     1.215 |      1.178 | 181.000 |
| asset_n_house_b          |   2.829 |      0.03 |      0.118 | 543.000 |
| in_business_b            |   0.398 |     0.038 |      0.017 | 265.000 |
| child_total_b            |   3.263 |     0.118 |      0.108 | 594.000 |
| hh_size_b                |   7.232 |    -0.175 |        0.3 | 648.000 |
...
df_1['c_textiles_b'] = np.log(df_1['c_textiles_b'])
df_1.boxplot(column = 'c_textiles_b', by = 'Group')
plt.savefig("textiles_nonzero.png")

df_1['asset_val_mobile_b'] = np.log(df_1['asset_val_mobile_b'])
...
|                          |  Control | Delta TUP | Delta Cash |       N |
|--------------------------+----------+-----------+------------+---------|
| c_meat_b                 |     6.87 |      0.01 |     -0.182 | 378.000 |
| c_fish_b                 |    3.305 |     0.089 |     -0.138 | 474.000 |
| c_cereals_b              |    9.706 |    -0.648 |      0.317 | 605.000 |
| c_sugar_b                |    1.837 |    -0.087 |     -0.179 | 604.000 |
| c_egg_b                  |    2.567 |     0.016 |     -0.261 | 276.000 |
| c_oil_b                  |    1.425 |    -0.093 |      -0.14 | 613.000 |
| c_beans_b                |    2.446 |     0.742 |      0.343 | 192.000 |
| c_fruit_b                |    1.577 |      -0.0 |     -0.047 | 272.000 |
| c_salt_b                 |    0.474 |    -0.034 |     -0.001 | 617.000 |
| c_vegetables_b           |    2.095 |     -0.14 |     -0.258 | 471.000 |
| c_milk_b                 |    6.936 |    -0.035 |     -1.723 | 114.000 |
| c_spices_b               |    0.995 |    -0.026 |     -0.202 | 158.000 |
| c_alcohol_b              |    1.333 |     0.167 |      0.333 |  18.000 |
| c_otherfood_b            |      nan |       nan |        nan |   0.000 |
| c_fuel_b                 |    1.065 |    -0.002 |     -0.103 | 456.000 |
| c_soap_b                 |    0.583 |    -0.007 |     -0.027 | 536.000 |
| c_transport_b            |     0.53 |    -0.002 |      0.119 | 193.000 |
| c_cosmetics_b            |    0.904 |     0.108 |     -0.092 | 468.000 |
| c_entertainment_b        |    0.341 |    -0.028 |      0.009 | 145.000 |
| c_clothesfootwear_b      |    0.706 |    -0.001 |      0.046 | 595.000 |
| c_charities_b            |    0.144 |    -0.032 |      0.009 | 134.000 |
| c_ceremonies_b           |    0.514 |     0.161 |       0.14 | 152.000 |
| c_textiles_b             |    0.259 |     0.017 |     0.078* | 376.000 |
| c_utensils_b             |    0.357 |     0.006 |      0.002 | 442.000 |
| c_dowry_b                |    5.694 |     1.918 |      0.674 | 126.000 |
| c_furniture_b            |    0.338 |     0.001 |      0.065 | 368.000 |
| c_other_b                |      nan |       nan |        nan |   0.000 |
| asset_val_cows_b         | 3746.316 |   -690.76 |  -1024.887 |  35.000 |
| asset_val_smallanimals_b | 1187.232 |  -388.754 |   -517.232 | 123.000 |
| asset_val_bicycle_b      |  369.277 |     23.24 |     63.223 | 171.000 |
| asset_val_radio_b        |   144.07 |    -16.02 |     -31.07 | 260.000 |
| asset_val_motorcycle_b   | 2909.939 |   616.142 |    840.104 |  93.000 |
| asset_val_net_b          |   29.588 |     0.656 |      0.128 | 423.000 |
| asset_val_poultry_b      |  172.681 |   -16.534 |    -38.649 | 161.000 |
| asset_val_bed_b          |  304.022 |     1.606 |      39.21 | 521.000 |
| asset_val_chairtables_b  |  255.978 |   -45.832 |     10.247 | 531.000 |
| asset_val_mobile_b       |  148.957 |   22.254* |      9.591 | 414.000 |
| asset_val_netITN_b       |    30.11 |     -0.71 |      3.709 | 181.000 |
| asset_n_house_b          |    3.216 |    -0.031 |     -0.016 | 543.000 |
| in_business_b            |      1.0 |       0.0 |        0.0 | 265.000 |
| child_total_b            |     3.61 |     0.056 |      0.025 | 594.000 |
| hh_size_b                |    7.232 |    -0.175 |        0.3 | 648.000 |
...
"""Total number of households in sample by group and round"""
...
"""Number of households in sample with baseline survey by group and round"""
...
# count the number in each treatment group
dd2013 = d2013
dd2014 = {'Cash': bygroupdf_b_m.at['Cash','idno'],'Control': bygroupdf_b_m.at['Control','idno'],'TUP': bygroupdf_b_m.at['TUP','idno'],'All': df_b_m.Group.notna().sum()}
dd2015 = {'Cash': bygroupdf_b_e.at['Cash','idno'],'Control': bygroupdf_b_e.at['Control','idno'],'TUP': bygroupdf_b_e.at['TUP','idno'],'All': df_b_e.Group.notna().sum()}

# make the table for number of households in sample with baseline survey by group and round
dd = {'2013': dd2013, '2014': dd2014, '2015': dd2015}
table2 = pd.DataFrame(data = dd) 

newdf2 = df_to_orgtbl(table2, float_fmt = '%.3f')
print(newdf2)
...
| Control | 281.000 | 265.000 | 347.000 |
| TUP     | 244.000 | 228.000 | 236.000 |
| All     | 649.000 | 606.000 | 694.000 |
...
|--------------------------+---------------+----------+----------|
| asset_n_house_b          |         2.863 |    0.305 |    0.367 |
| asset_val_bed_b          |       250.535 |   12.649 |  -51.133 |
| asset_val_bicycle_b      |       102.174 |   11.179 |    4.212 |
| asset_val_chairtables_b  |       196.436 |   -0.303 |  -37.177 |
| asset_val_cows_b         |       181.402 |   67.862 |  -89.273 |
| asset_val_mobile_b       |       101.482 |    6.336 |  -13.028 |
| asset_val_motorcycle_b   |       481.886 |  213.002 | -241.819 |
| asset_val_netITN_b       |         8.504 |   -1.777 |    0.449 |
| asset_val_net_b          |        19.462 |    0.332 |    2.814 |
| asset_val_poultry_b      |        39.438 |  23.634* |   -2.243 |
| asset_val_radio_b        |        53.046 |   -6.333 | -35.093* |
| asset_val_smallanimals_b |       180.716 |   18.966 |  -79.014 |
| c_alcohol_b              |          0.04 |    0.005 |   -0.004 |
| c_beans_b                |         0.826 |    0.269 |   -0.382 |
| c_cereals_b              |         8.883 |   -0.084 | -3.714** |
| c_ceremonies_b           |         0.139 |   -0.019 |   -0.038 |
| c_charities_b            |         0.027 |    0.007 |   -0.001 |
| c_clothesfootwear_b      |         0.655 |   0.177* |   -0.203 |
| c_cosmetics_b            |         0.668 |    0.005 |    0.229 |
| c_dowry_b                |         1.247 |    0.745 |   -0.394 |
| c_egg_b                  |         1.069 |   -0.005 |    0.106 |
| c_entertainment_b        |         0.074 |    0.021 |   0.051* |
| c_fish_b                 |         2.418 |   -0.132 |    0.036 |
| c_fruit_b                |         0.657 |    0.009 |   -0.151 |
| c_fuel_b                 |         0.733 |    0.105 |   -0.049 |
| c_furniture_b            |         0.199 |   -0.023 |     0.02 |
| c_meat_b                 |         3.982 |    0.254 |      0.3 |
| c_milk_b                 |          1.15 |    0.283 |    0.239 |
| c_oil_b                  |         1.288 |    0.037 |  -0.532* |
| c_other_b                |           0.0 |      0.0 |      0.0 |
| c_otherfood_b            |           0.0 |      0.0 |      0.0 |
| c_salt_b                 |         0.439 | -0.14*** |   -0.043 |
| c_soap_b                 |         0.475 |  -0.181* |    0.047 |
| c_spices_b               |         0.231 |    0.024 |   -0.048 |
| c_sugar_b                |         1.648 |   -0.285 |    -0.02 |
| c_textiles_b             |         0.163 |     0.01 |    0.011 |
| c_transport_b            |         0.164 |    0.004 |    0.018 |
| c_utensils_b             |         0.245 |    0.061 |   -0.023 |
| c_vegetables_b           |         1.447 |    0.096 |   -0.151 |
| child_total_b            |         3.328 | 0.656*** |    0.423 |
| hh_size_b                |         7.224 |  0.595** |    0.428 |
| in_business_b            |         0.415 |    0.038 |    0.007 |
...
# add in the dummy variables that need 0 as one of their values
df_1 = df_1.join(df[ ['in_midline', 'in_endline', 'in_business_b'] ])
...
|                          | mean_baseline |  beta_mid |  beta_end |
|--------------------------+---------------+-----------+-----------|
| asset_n_house_b          |         3.201 |    0.323* |     0.301 |
| asset_val_bed_b          |       312.086 |    19.135 | -110.358* |
| asset_val_bicycle_b      |       387.784 |    24.565 |    11.956 |
| asset_val_chairtables_b  |       240.089 |    17.727 |   -42.563 |
| asset_val_cows_b         |      3363.714 |  1187.333 |    1087.0 |
| asset_val_mobile_b       |       159.087 |    16.765 |   -16.258 |
| asset_val_motorcycle_b   |      3362.839 |  1133.611 |  -275.119 |
| asset_val_netITN_b       |        30.492 |    -0.263 |    -7.101 |
| asset_val_net_b          |        29.861 |     2.671 |     2.337 |
| asset_val_poultry_b      |       158.975 |   71.043* |   -15.736 |
| asset_val_radio_b        |       132.412 |   -20.601 |  -92.91** |
| asset_val_smallanimals_b |       953.537 |   336.985 |  -119.915 |
| c_alcohol_b              |         1.426 |    -0.271 |     0.479 |
| c_beans_b                |         2.793 |   1.151** |    -0.899 |
| c_cereals_b              |         9.529 |     0.213 |  -3.945** |
| c_ceremonies_b           |         0.595 |    -0.167 |    -0.145 |
| c_charities_b            |         0.133 |    -0.006 |     0.014 |
| c_clothesfootwear_b      |         0.714 |      0.2* |    -0.25* |
| c_cosmetics_b            |         0.927 |     0.074 |     0.292 |
| c_dowry_b                |         6.421 |     2.898 |    -0.352 |
| c_egg_b                  |         2.514 |    -0.117 |     0.035 |
| c_entertainment_b        |         0.333 |     0.022 |      0.16 |
| c_fish_b                 |          3.31 |    -0.088 |     0.191 |
| c_fruit_b                |         1.567 |     0.158 |    -0.194 |
| c_fuel_b                 |         1.044 |     0.186 |    -0.161 |
| c_furniture_b            |         0.352 |    -0.023 |     -0.01 |
| c_meat_b                 |         6.837 |   1.041** |     0.568 |
| c_milk_b                 |         6.547 |     0.911 |     1.305 |
| c_oil_b                  |         1.364 |     0.044 |  -0.682** |
| c_other_b                |           nan |       nan |       nan |
| c_otherfood_b            |           nan |       nan |       nan |
| c_salt_b                 |         0.461 | -0.149*** |    -0.054 |
| c_soap_b                 |         0.575 |   -0.182* |     -0.01 |
| c_spices_b               |         0.947 |    -0.185 |     -0.22 |
| c_sugar_b                |          1.77 |    -0.265 |    -0.059 |
| c_textiles_b             |         0.281 |     0.039 |     0.033 |
| c_transport_b            |         0.551 |    -0.042 |     0.032 |
| c_utensils_b             |         0.359 |     0.081 |    -0.067 |
| c_vegetables_b           |         1.994 |     0.286 |    -0.165 |
| child_total_b            |         3.636 |  0.633*** |     0.454 |
| hh_size_b                |         7.224 |   0.595** |     0.428 |
| in_business_b            |         0.415 |     0.038 |     0.007 |
...
df.insert(len(df.columns), '2013*Cash', df['2013']*df['Cash'])
df.insert(len(df.columns), '2014*Cash', df['2014']*df['Cash'])
df.insert(len(df.columns), '2015*Cash', df['2015']*df['Cash'])

controls = ['2014', '2015', '2014*TUP', '2015*TUP', '2014*Cash', '2015*Cash']
