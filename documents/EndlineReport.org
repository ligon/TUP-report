...
Poor rural households often earn money from low-return activities such as
...
and support by extension officers citep:bandiera-etal17.  The general framework[fn:: Also known as the
...
consumption citep:banerjee-etal15. 
...
To provide some insight into this question, we worked with BRAC's
South Sudanese branch office in Yei county to randomize selection for
their pilot TUP program. After a census identified 745 eligible
households, 250 were enrolled in the pilot "TUP" program; another 125
were assigned to a "UCT" group which was given cash roughly equal to
the value of the physical assets provided to TUP households; and
another 274 households were assigned to a control group.  While a body
of research exists on each of these two approaches to wealth transfers
approached singly, this study provides the first side-by-side
experimental evaluation of the two approaches.

* The TUP Program
   
The program itself was similar to the other TUP programs completed by
BRAC. It consisted of four phases: targeting and selection, training
and enterprise selection, asset transfers, and monitoring.
...
total value of all transfers to $350--$410.

*** Cash Transfers 

We randomly assigned each of the 125 households in the UCT group to
receive a cash transfer of either $350 or $410, matching the values of
assets received by households in the TUP treatments. Unfortunately,
political instability disrupted NGO operations throughtout South
Sudan, preventing the simultaneous disbursal of the cash and asset
transfers. Instead, a second survey was conducted in June of 2014,
with the cash transfers being disbursed immediately thereafter. This
resulted in a timing difference of 3 to 6 months between the two
(since the asset transfers were rolled out over around 12 weeks).
This naturally complicates the comparison of treatment effects between
the two treatments. We will describe our empirical strategy in light
of these challenges in Section [[*Empirical Strategy]].

Cash transfers were delivered by field officers in person and in local
currency. That they were delivered in cash distinguishes these from
several other cash transfer programs.  For example,
cite:haushofer-shapiro16 deposited funds in a bank or mobile money
account, while cite:fafchamps-etal14 used money transfers.  In all of
these experiments transfers were denominated in the local currency.
Howver, experimental studies of the behavioral implications of savings
...
|------------------------+---------+-----------+------------+---------|
| Consumption            | Control | Delta TUP | Delta UCT |       N |
|------------------------+---------+-----------+------------+---------|
...
|------------------------+---------------+----------+----------|
| Assets                 | mean_baseline | beta_mid | beta_end |
|------------------------+---------------+----------+----------|
