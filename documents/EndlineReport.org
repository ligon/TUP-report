...
for further estimates of \log\lambda_{it}. We consider the average treatment effect
on households sampled for these mobile interviews, both for \log\lambda_{it} and for
