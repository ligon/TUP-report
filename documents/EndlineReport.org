...
Next steps: 
 - Consider that it doesn't make sense to ask for clothing and
   footwear in total and then women's clothes, children's clothes,
   school uniforms, and shoes separately in midline and endline. Both the total
