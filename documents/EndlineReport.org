...
|                          | Control | Delta TUP | Delta Cash |       N |
|--------------------------+---------+-----------+------------+---------|
| c_meat_b                 |   1.747 |     0.018 |      0.033 | 378.000 |
| c_fish_b                 |    0.96 |     0.041 |     -0.022 | 474.000 |
| c_cereals_b              |   1.934 |    -0.071 |     -0.019 | 605.000 |
| c_sugar_b                |   0.247 |     -0.06 |     -0.031 | 604.000 |
| c_egg_b                  |   0.712 |     0.011 |     -0.077 | 276.000 |
| c_oil_b                  |  -0.202 |     0.014 |     -0.035 | 613.000 |
| c_beans_b                |   0.571 |     0.135 |      0.127 | 192.000 |
| c_fruit_b                |   0.231 |     0.007 |      0.027 | 272.000 |
| c_salt_b                 |  -0.898 |    -0.054 |      0.001 | 617.000 |
| c_vegetables_b           |   0.433 |    -0.026 |     -0.047 | 471.000 |
| c_milk_b                 |   1.415 |    -0.015 |     -0.217 | 114.000 |
| c_spices_b               |   -0.24 |    -0.069 |      -0.21 | 158.000 |
| c_alcohol_b              |   0.205 |     0.104 |      0.305 |  18.000 |
| c_otherfood_b            |     nan |       nan |        nan |   0.000 |
| c_fuel_b                 |  -0.461 |     -0.01 |     -0.127 | 456.000 |
| c_soap_b                 |  -1.073 |    -0.051 |     -0.172 | 536.000 |
| c_transport_b            |  -1.006 |    -0.003 |      0.127 | 193.000 |
| c_cosmetics_b            |  -0.742 |     0.084 |     -0.054 | 468.000 |
| c_entertainment_b        |  -1.313 |     -0.13 |     -0.064 | 145.000 |
| c_clothesfootwear_b      |  -0.911 |    -0.005 |     -0.074 | 595.000 |
| c_charities_b            |  -2.552 |    -0.229 |     -0.121 | 134.000 |
| c_ceremonies_b           |  -1.478 |     0.261 |      0.162 | 152.000 |
| c_textiles_b             |  -1.804 |     0.052 |      0.112 | 376.000 |
| c_utensils_b             |  -1.548 |     -0.01 |     -0.003 | 442.000 |
| c_dowry_b                |   0.034 |     0.433 |      0.178 | 126.000 |
| c_furniture_b            |  -1.676 |     0.033 |      0.185 | 368.000 |
| c_other_b                |     nan |       nan |        nan |   0.000 |
| asset_val_cows_b         |   7.461 |    -0.072 |     -0.068 |  35.000 |
| asset_val_smallanimals_b |   6.425 |    -0.195 |     -0.364 | 123.000 |
| asset_val_bicycle_b      |   5.601 |     0.051 |       0.14 | 171.000 |
| asset_val_radio_b        |     4.3 |     0.067 |     -0.071 | 260.000 |
| asset_val_motorcycle_b   |   6.762 |     0.676 |      0.778 |  93.000 |
| asset_val_net_b          |   3.089 |     0.024 |     -0.008 | 423.000 |
| asset_val_poultry_b      |   4.616 |     0.002 |     -0.177 | 161.000 |
| asset_val_bed_b          |   5.306 |    -0.001 |      0.116 | 521.000 |
| asset_val_chairtables_b  |   4.889 |     0.021 |      0.025 | 531.000 |
| asset_val_mobile_b       |   4.811 |     0.119 |      0.031 | 414.000 |
| asset_val_netITN_b       |   3.147 |    -0.047 |       0.13 | 181.000 |
| asset_n_house_b          |   1.064 |    -0.027 |       -0.0 | 543.000 |
| child_total_b            |   1.118 |     0.043 |      0.039 | 594.000 |
| hh_size_b                |   1.917 |    -0.021 |       0.05 | 648.000 |
| in_business_b            |   0.398 |     0.038 |      0.017 | 638.000 |
...
|                          | mean_baseline |  beta_mid | beta_end |
|--------------------------+---------------+-----------+----------|
| asset_n_house_b          |         1.054 |     0.083 |    0.071 |
| asset_val_bed_b          |         5.328 |     0.028 | -0.408** |
| asset_val_bicycle_b      |         5.642 |     0.106 |    0.015 |
| asset_val_chairtables_b  |         4.902 |     0.179 |   -0.224 |
| asset_val_cows_b         |         7.428 |     0.686 |    0.133 |
| asset_val_mobile_b       |         4.862 |     0.075 |   -0.174 |
| asset_val_motorcycle_b   |         7.223 |     0.918 |    0.787 |
| asset_val_netITN_b       |         3.151 |     0.034 |   -0.324 |
| asset_val_net_b          |         3.096 |     0.009 |    0.056 |
| asset_val_poultry_b      |         4.582 |     0.259 |    0.111 |
| asset_val_radio_b        |         4.314 |    -0.036 |   -0.354 |
| asset_val_smallanimals_b |          6.29 |     0.351 |    0.081 |
| c_alcohol_b              |         0.269 |    -0.272 |   0.633* |
| c_beans_b                |         0.648 |      0.3* |   -0.272 |
| c_cereals_b              |         1.905 |    -0.052 |  -0.255* |
| c_ceremonies_b           |         -1.36 |    -0.139 |   -0.085 |
| c_charities_b            |        -2.663 |    -0.241 |    0.076 |
| c_clothesfootwear_b      |        -0.927 |    0.234* |   -0.169 |
| c_cosmetics_b            |        -0.721 |     -0.03 |    0.062 |
| c_dowry_b                |         0.203 |     0.596 |    0.122 |
| c_egg_b                  |         0.699 |    -0.081 |    0.076 |
| c_entertainment_b        |        -1.368 |    -0.116 |    0.418 |
| c_fish_b                 |          0.97 |       0.0 |    0.028 |
| c_fruit_b                |         0.239 |     0.094 |   -0.114 |
| c_fuel_b                 |        -0.489 |     0.033 |   -0.257 |
| c_furniture_b            |        -1.627 |     0.041 |   -0.338 |
| c_meat_b                 |          1.76 |     0.133 |    0.105 |
| c_milk_b                 |         1.363 |     0.193 |    0.175 |
| c_oil_b                  |        -0.203 |    -0.054 |   -0.216 |
| c_other_b                |           nan |       nan |      nan |
| c_otherfood_b            |           nan |       nan |      nan |
| c_salt_b                 |        -0.918 | -0.154*** |   -0.053 |
| c_soap_b                 |        -1.125 |     -0.17 |   -0.086 |
| c_spices_b               |        -0.307 |     -0.19 |   -0.156 |
| c_sugar_b                |         0.219 |    -0.092 |   -0.116 |
| c_textiles_b             |        -1.762 |     0.099 |   -0.109 |
| c_transport_b            |        -0.985 |    -0.132 |    0.022 |
| c_utensils_b             |        -1.552 |      0.21 |    -0.24 |
| c_vegetables_b           |         0.415 |     0.095 |   -0.047 |
| child_total_b            |         1.142 |  0.219*** |   0.173* |
| hh_size_b                |         1.919 |   0.081** |    0.062 |
| in_business_b            |         0.415 |     0.038 |    0.007 |
