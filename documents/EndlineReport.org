...
*** Making box and whisker plots for Elliott's balance table
...
*** Making box and whisker plots for the new balance table

#+Caption: Box and whisker plot of textiles means for nonzero values
#+NAME: fig:box_whisker_textiles_nonzero
[[../documents/textiles_nonzero.png]]

#+Caption: Box and whisker plot of mobile means for nonzero values
