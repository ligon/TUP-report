...
interested in: what are the effects on consumption, about a year
...
print(df_to_orgtbl(b.filter(regex='\*').unstack(),sedf=se.filter(regex='\*').unstack()))
#+end_src

#+RESULTS: food_insecurity
|          | TUP*2014       | TUP*2015      | UCT*2014    | UCT*2015    |
|----------+----------------+---------------+-------------+-------------|
| fewmeals | \(-0.037\)     | \(0.063\)     | \(-0.012\)  | \(0.037\)   |
|          | (\(0.044\))    | (\(0.041\))   | (\(0.053\)) | (\(0.052\)) |
| hungry   | \(-0.058\)     | \(0.079\)^{*} | \(-0.017\)  | \(0.048\)   |
|          | (\(0.043\))    | (\(0.041\))   | (\(0.053\)) | (\(0.052\)) |
| nofood   | \(-0.085\)^{*} | \(0.025\)     | \(0.015\)   | \(0.051\)   |
|          | (\(0.044\))    | (\(0.042\))   | (\(0.054\)) | (\(0.053\)) |
| portions | \(0.065\)      | \(-0.014\)    | \(0.037\)   | \(-0.009\)  |
|          | (\(0.044\))    | (\(0.042\))   | (\(0.054\)) | (\(0.053\)) |
| wholeday | \(-0.020\)     | \(0.013\)     | \(-0.017\)  | \(-0.015\)  |
|          | (\(0.044\))    | (\(0.042\))   | (\(0.054\)) | (\(0.053\)) |
| worried  | \(0.055\)      | \(-0.019\)    | \(0.052\)   | \(-0.010\)  |
|          | (\(0.044\))    | (\(0.042\))   | (\(0.053\)) | (\(0.052\)) |
