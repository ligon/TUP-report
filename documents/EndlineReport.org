...
survey (although their estimates are reliant on the choice of control
group).[fn::More explicity, they find large positive effects by
comparing treatment households with the "control" group within
treatment villages (i.e. treatment vs. spillover samples). However,
most of the effects dissipate when using control households from
control village (i.e. treatment vs. "pure control"). See this blog at
[[https://blogs.worldbank.org/impactevaluations/givedirectly-three-year-impacts-explained]] for a discussion of this choice of control group.] In their long-term
follow-up survey, cite:blattman-etal20 find that the impacts of cash
transfers dissipated in Uganda after 9 years. While comparing results
across evaluations have various limitations, a few studies have
emabarked on comparing the two models in the same setting
citep:sedlmayr-etal20 or comparing asset versus in-kind transfers
(e.g. cite:fafchamps-etal14).
...
of poor people and letting them use these resources as they see best. The natural question that arises is whether (and how) these
...
With this introduction, Section [[The Program]] describes the experiment
and the interventions. Section [[The Data]] describes the data and our
empirical strategy. Results are discussed in Section [[Results]], and we
...
included questions to assess their eligibility to be beneficiaries
based on three exclusion and five inclusion criteria. Households were
excluded if they: a) had any member with a regular salary job; b) were
participating in any other NGO's livelihoods program; or c) had no
access to cultivable land.[fn::The third exclusion condition was
considered necessary as some of the enterprises planned under the UPG
model needed access to land.  Though this the third criterion goes
against targeting ultra-poor housheolds, it was needed due to market
analysis by BRAC revealing that agriculture was one of the viable
enterprises.  TODO: Can we add a sentence on how binding the criteria
was?]  If not excluded on any of these grounds, households were then
considered eligible if they met at least three of the following
inclusion conditions: a) the household head was working as a day
laborer; b) the household had two or more children; c) at least one
child in the household was working; d) the household had fewer than
three rooms; and e) the main woman in the household had not completed
secondary school.  Households which seemed to be eligible based on
their census responses had eligibility verified through group
discussions with the local leaders and community
representatives.[fn::While this targeting method is different from how
the targeting is done in other UPG programmes, Chowdhury and Morel
found that TODO]

The census was completed in April 2013 and covered 1279 households, of
which 755 were found to be eligible.  We then conducted a baseline
survey of these eligible households, successfully interviewing 649.
Among those who were interviewed at the baseline, 250 were randomly
assigned to participate in the UPG program, 125 were randomly assigned
to a UCT group, and the remaining 274 households were assigned to the
control group.  Randomization was done stratifying on four binary
household characteristics (viz. below median number of income earners,
below median of assets owned, whether involved in agriculture and
whether has a business). The study was registered on RIDIE (study ID
...
\begin{equation*}
Y_{it} =\alpha_{t}+\beta_{t,UCT}I_{t}*UCT_{i}+\beta_{t,UPG}I_{t}*UPG_{i}+\gamma Y_{i,2013}(1-M_{i,2013}) + \delta M_{i,2013} +\epsilon_{it},
\end{equation*}
...
\(\beta_{\mbox{UPG},t}=\beta_{\mbox{UCT},2015}\) for both of \(t \in
\{2014,2015\}\).
...
regard \(\beta_{\mbox{UPG},2014}=\beta_{\mbox{UCT},2015}\) as the
...
\(\beta_{\mbox{UPG},2015}-\beta_{\mbox{UCT},2015}\), which has the
...
asset holdings.  Since UPG households were directly /given/ a variety
of different assets, for this program this can be regarded as a rather
direct test---eight months later, do UPG recipients still own these
...
the value of assets measured.  This contrasts sharply with the UPG
group.  The UPG group gains significantly more asset wealth than the
...
# or because they overlap (e.g. nets & ITN nets) (as commented in UPG-data/UPG.py)
...
print(df_to_orgtbl(b,sedf=se))
 ...
 |-----------------------------------+-------------+------------+------------|
 | UPG*2014                          | 1617.966*** | 450.392*** | 377.437*** |
 |                                   | (230.986)   | (61.004)   | (52.762)   |
 | UPG*2015                          | 1298.628*** | 341.678*** | 322.614*** |
 |                                   | (230.986)   | (61.004)   | (52.762)   |
 ...
 | $N$                               | 1510        | 1510       | 1510       |
 |-----------------------------------+-------------+------------+------------|
 | $\beta_{UPG2014}-\beta_{UCT2015}$ | 1655.528*** | 429.916*** | 359.67***  |
 | $\beta_{UPG2015}-\beta_{UCT2015}$ | 1336.19***  | 321.202*** | 304.847*** |
...
final.rename(index = {0: "CTL mean", 1: " ", 2: "UPG*2014", 3: "  ", 
                      ...
                      20: r"$\beta_{UPG2014}-\beta_{UCT2015}$", 21: r"$\beta_{UPG2015}-\beta_{UCT2015}$"}, inplace=True)
...
#+LATEX: \begin{landscape}
 ...
 |-----------------------------------+----------+----------+----------+--------------+---------------+--------------|
 | $\beta_{UPG2014}-\beta_{UCT2015}$ | 0.28***  | 0.185*** | 0.212*** | 0.107**      | 0.075*        | 0.165***     |
 | $\beta_{UPG2015}-\beta_{UCT2015}$ | 0.176*** | 0.039    | 0.027    | 0.021        | 0.035         | 0.039        |
#+LATEX: \end{landscape}
...
#+LATEX: \begin{landscape}
 ...
 |-----------------------------------+-----------+----------+----------+--------------+---------------+--------------|
 | $\beta_{UPG2014}-\beta_{UCT2015}$ | -0.818*** | 0.478*   | 0.553**  |        -0.39 | 0.50          | 0.10         |
 | $\beta_{UPG2015}-\beta_{UCT2015}$ | 0.05      | 0.17     | 0.22     |        -0.33 | -0.30         | -0.14        |
#+LATEX: \end{landscape}
...
|                                         | (3.89)       | (16.56)      | (103.24)      |
| $\beta_{UPG2014}-\beta_{UCT2015}$       | 4.23         | -10.58       | 483.67^{*}    |
|                                         | (9.17)       | (48.36)      | (273.11)      |
| $\beta_{UPG2015}-\beta_{UCT2015}$       | -12.36^{*}   | -35.06       | 39.77         |
|                                         | (7.45)       | (39.29)      | (221.80)      |
...
|-------------------------------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------|
| $\beta_{UPG2014} - \beta_{UCT2015}$ | \(-0.073\)      | \(-0.105\)      | \(-0.136\)^{**} | \(0.074\)       | \(-0.004\)      | \(0.065\)       |
|                                     | (\(0.068\))     | (\(0.068\))     | (\(0.068\))     | (\(0.068\))     | (\(0.069\))     | (\(0.068\))     |
| $\beta_{UPG2015} - \beta_{UCT2015}$ | \(0.027\)       | \(0.032\)       | \(-0.026\)      | \(-0.005\)      | \(0.028\)       | \(-0.008\)      |
