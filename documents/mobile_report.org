...
<<Imports>>
DataDir = "../../data/"
File = DataDir+"Mobile/remote_survey_Nov2015_Feb2016.dta"
...
"January 2016":"3January", "February 2016":"4February"}
...
if not set_thresholds: #~ thresholds set manually
...
|-----------------+-----------------+---------------+-----------------+---------------+-----------------+------------|
|                 | Buy_amt         | Buy_any       | Sell_amt        | Sell_any      | Total           | lambdas    |
|-----------------+-----------------+---------------+-----------------+---------------+-----------------+------------|
| Cash            | $29.842$        | $0.076^{***}$ | $63.476$        | $0.068^{***}$ | $18.812^{**}$   | $-0.103$   |
|                 | $(27.748)$      | $(0.023)$     | $(47.276)$      | $(0.025)$     | $(8.761)$       | $(0.069)$  |
| TUP             | $43.669^{**}$   | $0.035^{*}$   | $54.898$        | $0.085^{***}$ | $-0.567$        | $0.077$    |
|                 | $(21.931)$      | $(0.018)$     | $(37.364)$      | $(0.020)$     | $(7.068)$       | $(0.055)$  |
| C(t)[1November] | $51.676^{**}$   | $0.103^{***}$ | $26.889$        | $0.094^{***}$ | $166.409^{***}$ | $-0.007$   |
|                 | $(21.633)$      | $(0.018)$     | $(36.856)$      | $(0.020)$     | $(7.115)$       | $(0.056)$  |
| C(t)[2December] | $55.425^{***}$  | $0.154^{***}$ | $59.127^{*}$    | $0.182^{***}$ | $209.083^{***}$ | $-0.035$   |
|                 | $(20.280)$      | $(0.017)$     | $(34.551)$      | $(0.018)$     | $(6.824)$       | $(0.054)$  |
| C(t)[3January]  | $52.096^{**}$   | $0.076^{***}$ | $132.102^{***}$ | $0.142^{***}$ | $232.485^{***}$ | $0.003$    |
|                 | $(20.799)$      | $(0.017)$     | $(35.436)$      | $(0.019)$     | $(6.941)$       | $(0.054)$  |
| C(t)[4February] | $202.982^{***}$ | $0.336^{***}$ | $355.032^{***}$ | $0.321^{***}$ | $287.873^{***}$ | $0.016$    |
|                 | $(30.986)$      | $(0.026)$     | $(52.793)$      | $(0.028)$     | $(9.935)$       | $(0.078)$  |
|-----------------+-----------------+---------------+-----------------+---------------+-----------------+------------|
| baseline        | $ $             | $ $           | $ $             | $ $           | $2.750$         | $0.000$    |
|                 |                 |               |                 |               | $(5.037)$       | $(0.040)$  |
|-----------------+-----------------+---------------+-----------------+---------------+-----------------+------------|
| N               | $1937.000$      | $1937.000$    | $1937.000$      | $1937.000$    | $1720.000$      | $1719.000$ |
|-----------------+-----------------+---------------+-----------------+---------------+-----------------+------------|
#+end_example
